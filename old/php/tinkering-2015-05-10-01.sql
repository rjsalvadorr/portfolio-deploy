...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2015 at 08:29 PM
...
INSERT INTO `quiz` (`quiz_id`, `quiz_type_id`, `name`, `description`, `active`, `extra_data`) VALUES
(1, 1, 'Test DB Quiz', 'Fresh from the database!', 1, NULL),
(2, 2, 'test02', 'test02', 0, NULL),
(3, 3, 'test03', 'test03', 0, NULL);
...
INSERT INTO `quiz_item` (`quiz_item_id`, `quiz_id`, `question`, `answer`) VALUES
(1, 1, 'funk', 'funk'),
(2, 1, 'woot', 'woot'),
(3, 2, 'question01', 'answer01, answer02, answer03, answer04'),
(4, 2, 'question02', 'answer01, answer02, answer03, answer04');
...
(1, 'text', 'Simple text answer'),
(3, 'matching', ''),
(4, 'music_keys', 'For memorizing the circle of fifths'),
(5, 'music_guitar_fretboard', 'For memorizing the guitar fretboard!');
...
--
ALTER TABLE `quiz_item`
MODIFY `quiz_item_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `quiz_type`
--
ALTER TABLE `quiz_type`
MODIFY `quiz_type_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=44;
